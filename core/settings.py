...
if not DEBUG:
    ...
    SECRET_KEY = 'django-insecure-t5j$0*7t9vwvj%drqk4np*ag+yepj9wq^cu&qb!a-0didis^i9'
...
DATABASES = {
    'default': {
        'ENGINE': f'django.db.backends.{os.getenv("DB_ENGINE", default="sqlite3")}',
        'NAME': os.getenv('DB_NAME', default=f"{BASE_DIR}/db.sqlite3"),
